...
const appBasePath = 'MapboxGLAndroidSDKTestApp/src/main/java/vn/vietmap/vietmapsdk/testapp/activity';
const testBasePath = 'MapboxGLAndroidSDKTestApp/src/androidTest/java/vn/vietmap/vietmapsdk/testapp/activity/gen';
const subPackages = fs.readdirSync(appBasePath);
const ejsConversionTask = ejs.compile(fs.readFileSync('MapboxGLAndroidSDKTestApp/src/androidTest/java/vn/vietmap/vietmapsdk/testapp/activity/activity.junit.ejs', 'utf8'), {strict: true});
