...
class LocationComponentPositionManagerTest {
    ...
    fun update_noChange_null() {
        val positionManager =
            vn.vietmap.vietmapsdk.location.LocationComponentPositionManager(style, null, null)
    ...
    fun update_noChange_above() {
        val positionManager =
            vn.vietmap.vietmapsdk.location.LocationComponentPositionManager(style, "above", null)
    ...
    fun update_noChange_below() {
        val positionManager =
            vn.vietmap.vietmapsdk.location.LocationComponentPositionManager(style, null, "below")
    ...
    fun update_fromValue_above() {
        val positionManager =
            vn.vietmap.vietmapsdk.location.LocationComponentPositionManager(style, "above1", null)
    ...
    fun update_fromValue_below() {
        val positionManager =
            vn.vietmap.vietmapsdk.location.LocationComponentPositionManager(style, null, "below1")
