...
class VietmapMapOptionsAttrsTest {

    @RelaxedMockK
    private lateinit var options: vn.vietmap.vietmapsdk.maps.VietmapMapOptions
    ...
    fun enabledLocalIdeographFontFamily() {
        ...
        val options = vn.vietmap.vietmapsdk.maps.VietmapMapOptions.createFromAttributes(options, context, typedArray)
