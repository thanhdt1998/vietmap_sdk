...
class TransformTest {
    ...
    fun setup() {
        ...
        transform =
            vn.vietmap.vietmapsdk.maps.Transform(mapView, nativeMapView, cameraChangeDispatcher)
        every { nativeMapView.isDestroyed } returns false
        every { nativeMapView.cameraPosition } returns vn.vietmap.vietmapsdk.camera.CameraPosition.DEFAULT
    ...
    @Test
    fun testMoveCamera() {
        val VietmapMap = mockk<vn.vietmap.vietmapsdk.maps.VietmapMap>()
        every { VietmapMap.cameraPosition } answers { vn.vietmap.vietmapsdk.camera.CameraPosition.DEFAULT }
        ...
        transform.moveCamera(VietmapMap, update, callback)
    ...
    fun testMoveCameraToSamePosition() {
        ...
        val expected = vn.vietmap.vietmapsdk.camera.CameraPosition.DEFAULT
        val update = vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newCameraPosition(expected)

        transform.moveCamera(VietmapMap, update, null) // Initialize camera position
        transform.moveCamera(VietmapMap, update, callback)
    ...
    fun testEaseCamera() {
        ...
        transform.easeCamera(VietmapMap, update, 100, false, callback)
    ...
    fun testEaseCameraToSamePosition() {
        ...
        val expected = vn.vietmap.vietmapsdk.camera.CameraPosition.DEFAULT
        val update = vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newCameraPosition(expected)
        transform.moveCamera(VietmapMap, update, null)
    ...
    fun testAnimateCamera() {
        ...
        transform.animateCamera(VietmapMap, update, 100, callback)
    ...
    fun testCancelNotInvokedFromOnFinish() {
        val slot = slot<vn.vietmap.vietmapsdk.maps.MapView.OnCameraDidChangeListener>()
        ...
        val callback = object : vn.vietmap.vietmapsdk.maps.VietmapMap.CancelableCallback {
            override fun onCancel() {
                throw IllegalStateException("onCancel shouldn't be called from onFinish")
            }

            override fun onFinish() {
                transform.animateCamera(VietmapMap, vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newCameraPosition(expected), 500, null)
            }
        }
        transform.animateCamera(VietmapMap, vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newCameraPosition(expected), 500, callback)
    }
}
