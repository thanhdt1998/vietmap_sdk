...
class MapboxAnimatorTest {
    ...
    fun fps_unlimited() {
        ...
        val listener = mockk<vn.vietmap.vietmapsdk.location.MapboxAnimator.AnimationsValueChangeListener<Float>>()
        every { listener.onNewAnimationValue(any()) } answers {}
        val mapboxAnimator = vn.vietmap.vietmapsdk.location.MapboxFloatAnimator(
            floatArrayOf(
                0f,
                10f
