...
class StyleBuilderTest {
    ...
    @Test
    fun testWithLayers() {
        val layer1 = mockk<vn.vietmap.vietmapsdk.style.layers.SymbolLayer>()
        val layer2 = mockk<vn.vietmap.vietmapsdk.style.layers.SymbolLayer>()
        val builder = vn.vietmap.vietmapsdk.maps.Style.Builder()
    ...
    fun testWithLayerAt() {
        ...
        assertEquals(layer, builder.layers[0].layer)
        assertEquals(expectedIndex, (builder.layers[0] as vn.vietmap.vietmapsdk.maps.Style.Builder.LayerAtWrapper).index)
    }
    ...
    fun testWithLayerAbove() {
        ...
        assertEquals(layer, builder.layers[0].layer)
        assertEquals(expectedAbove, (builder.layers[0] as vn.vietmap.vietmapsdk.maps.Style.Builder.LayerAboveWrapper).aboveLayer)
    }
    ...
    fun testWithLayerBelow() {
        ...
        assertEquals(layer, builder.layers[0].layer)
        assertEquals(expectedBelow, (builder.layers[0] as vn.vietmap.vietmapsdk.maps.Style.Builder.LayerBelowWrapper).belowLayer)
    }
    ...
    @Test
    fun testWithSources() {
        val source1 = mockk<vn.vietmap.vietmapsdk.style.sources.GeoJsonSource>()
        val source2 = mockk<vn.vietmap.vietmapsdk.style.sources.GeoJsonSource>()
        val builder = vn.vietmap.vietmapsdk.maps.Style.Builder()
    ...
    fun testWithImageDrawable() {
        ...
        assertTrue(
            vn.vietmap.vietmapsdk.utils.BitmapUtils.equals(
                vn.vietmap.vietmapsdk.utils.BitmapUtils.getBitmapFromDrawable(drawable)!!,
    ...
    fun testWithImageDrawables() {
        ...
        assertTrue(
            vn.vietmap.vietmapsdk.utils.BitmapUtils.equals(
                vn.vietmap.vietmapsdk.utils.BitmapUtils.getBitmapFromDrawable(drawable1)!!,
                builder.images[0].bitmap
            )
        )
        assertEquals("id1", builder.images[0].id)
        ...
        assertTrue(
            vn.vietmap.vietmapsdk.utils.BitmapUtils.equals(
                vn.vietmap.vietmapsdk.utils.BitmapUtils.getBitmapFromDrawable(drawable2)!!,
