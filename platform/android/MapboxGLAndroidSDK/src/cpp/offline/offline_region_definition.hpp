...
public:
    static constexpr auto Name() { return "vn/vietmap/vietmapsdk/offline/OfflineRegionDefinition"; };
...
public:
    ...
    static constexpr auto Name() { return "vn/vietmap/vietmapsdk/offline/OfflineTilePyramidRegionDefinition"; };
...
public:
    using SuperTag = OfflineRegionDefinition;
    static constexpr auto Name() { return "vn/vietmap/vietmapsdk/offline/OfflineGeometryRegionDefinition"; };
