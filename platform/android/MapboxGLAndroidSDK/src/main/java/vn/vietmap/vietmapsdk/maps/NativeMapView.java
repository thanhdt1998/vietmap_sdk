...
import vn.vietmap.vietmapsdk.exceptions.CalledFromWorkerThreadException;
import vn.vietmap.vietmapsdk.geometry.LatLng;
import vn.vietmap.vietmapsdk.geometry.LatLngBounds;
import vn.vietmap.vietmapsdk.geometry.ProjectedMeters;
...
final class NativeMapView implements NativeMap {
  ...
  private VietmapMap.SnapshotReadyCallback snapshotReadyCallback;
  ...
  @Override
  public void addSnapshotCallback(@NonNull VietmapMap.SnapshotReadyCallback callback) {
  ...
  @Override
  public void setOnFpsChangedListener(@Nullable final VietmapMap.OnFpsChangedListener listener) {
    ...
    mapRenderer.queueEvent(new Runnable() {
      ...
      public void run() {
        if (listener != null) {
          mapRenderer.setOnFpsChangedListener(new VietmapMap.OnFpsChangedListener() {
            @Override
