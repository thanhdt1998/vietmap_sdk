package vn.vietmap.vietmapsdk.maps.renderer.glsurfaceview;
...
import vn.vietmap.vietmapsdk.maps.renderer.egl.EGLLogWrapper;
 ...
 */
public class VietmapGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {

  private static final String TAG = "GLSurfaceView";
  private static final GLThreadManager glThreadManager = new GLThreadManager();

  private final WeakReference<VietmapGLSurfaceView> viewWeakReference = new WeakReference<>(this);
   ...
   */
  public VietmapGLSurfaceView(Context context) {
    super(context);
    init();
  }
   ...
   * must call {@link #setRenderer} to register a renderer.
   */
  public VietmapGLSurfaceView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
  ...
  private static class EglHelper {
    private EglHelper(WeakReference<VietmapGLSurfaceView> glSurfaceViewWeakRef) {
    ...
    public void start() {
      try {
        ...
        VietmapGLSurfaceView view = mGLSurfaceViewWeakRef.get();
        if (view == null) {
          mEglConfig = null;
          mEglContext = null;
        } else {
    ...
    private WeakReference<VietmapGLSurfaceView> mGLSurfaceViewWeakRef;
    EGL10 mEgl;
  ...
  static class GLThread extends Thread {
    GLThread(WeakReference<VietmapGLSurfaceView> glSurfaceViewWeakRef) {
      super();
      width = 0;
      height = 0;
      requestRender = true;
  ...
  /**
   * Listener interface that notifies when a {@link VietmapGLSurfaceView} is detached from window.
   */
  public interface OnGLSurfaceViewDetachedListener {

    /**
     * Called when a {@link VietmapGLSurfaceView} is detached from window.
     */
