...
import static vn.vietmap.vietmapsdk.maps.VietmapMap.OnCameraMoveStartedListener;
...
public final class Transform implements MapView.OnCameraDidChangeListener {
  ...
  @Nullable
  private VietmapMap.CancelableCallback cameraCancelableCallback;
  ...
  void initialise(@NonNull VietmapMap VietmapMap, @NonNull VietMapOptions options) {
    CameraPosition position = options.getCamera();
    if (position != null && !position.equals(CameraPosition.DEFAULT)) {
      moveCamera(VietmapMap, CameraUpdateFactory.newCameraPosition(position), null);
    }
  ...
  public void onCameraDidChange(boolean animated) {
    if (animated) {
      ...
      if (cameraCancelableCallback != null) {
        final VietmapMap.CancelableCallback callback = cameraCancelableCallback;
   ...
   */
  @UiThread
  public final void moveCamera(@NonNull VietmapMap VietmapMap, CameraUpdate update,
                               @Nullable final VietmapMap.CancelableCallback callback) {
    CameraPosition cameraPosition = update.getCameraPosition(VietmapMap);
  ...
  @UiThread
  final void easeCamera(@NonNull VietmapMap VietmapMap, CameraUpdate update, int durationMs, boolean easingInterpolator,
                        @Nullable final VietmapMap.CancelableCallback callback) {
    CameraPosition cameraPosition = update.getCameraPosition(VietmapMap);
    if (isValidCameraPosition(cameraPosition)) {
      cancelTransitions();
   ...
   */
  @UiThread
  public final void animateCamera(@NonNull VietmapMap VietmapMap, CameraUpdate update, int durationMs,
                                  @Nullable final VietmapMap.CancelableCallback callback) {
    CameraPosition cameraPosition = update.getCameraPosition(VietmapMap);
    if (isValidCameraPosition(cameraPosition)) {
      cancelTransitions();
  ...
  void setMinZoom(double minZoom) {
    if ((minZoom < VietmapConstants.MINIMUM_ZOOM) || (minZoom > VietmapConstants.MAXIMUM_ZOOM)) {
  ...
  void setMaxZoom(double maxZoom) {
    if ((maxZoom < VietmapConstants.MINIMUM_ZOOM) || (maxZoom > VietmapConstants.MAXIMUM_ZOOM)) {
  ...
  void setMinPitch(double minPitch) {
    if ((minPitch < VietmapConstants.MINIMUM_PITCH) || (minPitch > VietmapConstants.MAXIMUM_PITCH)) {
  ...
  void setMaxPitch(double maxPitch) {
    if ((maxPitch < VietmapConstants.MINIMUM_PITCH) || (maxPitch > VietmapConstants.MAXIMUM_PITCH)) {
