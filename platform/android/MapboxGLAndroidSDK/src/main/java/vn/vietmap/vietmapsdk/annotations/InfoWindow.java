...
public class InfoWindow {
  ...
  private WeakReference<VietmapMap> vietmapMap;
  ...
  InfoWindow(MapView mapView, int layoutResId, VietmapMap vietmapMap) {
    layoutRes = layoutResId;
    View view = LayoutInflater.from(mapView.getContext()).inflate(layoutResId, mapView, false);
    initialize(view, vietmapMap);
  }

  InfoWindow(@NonNull View view, VietmapMap vietmapMap) {
    initialize(view, vietmapMap);
  }

  private void initialize(@NonNull View view, VietmapMap vietmapMap) {
    this.vietmapMap = new WeakReference<>(vietmapMap);
    isVisible = false;
    ...
    view.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        VietmapMap vietmapMap = InfoWindow.this.vietmapMap.get();
        if (vietmapMap != null) {
          VietmapMap.OnInfoWindowClickListener onInfoWindowClickListener = vietmapMap.getOnInfoWindowClickListener();
    ...
    view.setOnLongClickListener(new View.OnLongClickListener() {
      ...
      public boolean onLongClick(View v) {
        VietmapMap vietmapMap = InfoWindow.this.vietmapMap.get();
        if (vietmapMap != null) {
          VietmapMap.OnInfoWindowLongClickListener listener = vietmapMap.getOnInfoWindowLongClickListener();
          if (listener != null) {
  ...
  private void closeInfoWindow() {
    VietmapMap mapbox = vietmapMap.get();
  ...
  InfoWindow open(@NonNull MapView mapView, Marker boundMarker, @NonNull LatLng position, int offsetX, int offsetY) {
    ...
    VietmapMap vietmapMap = this.vietmapMap.get();
    View view = this.view.get();
    if (view != null && vietmapMap != null) {
      ...
      coordinates = vietmapMap.getProjection().toScreenLocation(position);
  ...
  InfoWindow close() {
    ...
    if (isVisible && vietmapMap != null) {
      ...
      VietmapMap.OnInfoWindowCloseListener listener = vietmapMap.getOnInfoWindowCloseListener();
      if (listener != null) {
   ...
   * @param vietmapMap
   */
  void adaptDefaultMarker(@NonNull Marker overlayItem, VietmapMap vietmapMap, @NonNull MapView mapView) {
    View view = this.view.get();
    if (view == null) {
  ...
  public void update() {
    ...
    Marker marker = boundMarker.get();
    View view = this.view.get();
    if (vietmapMap != null && marker != null && view != null) {
      coordinates = vietmapMap.getProjection().toScreenLocation(marker.getPosition());
