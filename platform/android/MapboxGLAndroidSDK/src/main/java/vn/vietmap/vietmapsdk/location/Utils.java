...
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.INSTANT_LOCATION_TRANSITION_THRESHOLD;

public final class Utils {

  private static final String TAG = "Mbgl-vn.vietmap.vietmapsdk.location.Utils";
  ...
  static float calculateZoomLevelRadius(@NonNull VietmapMap VietmapMap, @Nullable Location location) {
    if (location == null) {
      return 0;
    }
    double metersPerPixel = VietmapMap.getProjection().getMetersPerPixelAtLatitude(location.getLatitude());
