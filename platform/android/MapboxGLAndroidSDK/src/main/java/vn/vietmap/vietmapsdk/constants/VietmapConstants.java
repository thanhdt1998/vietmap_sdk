package vn.vietmap.vietmapsdk.constants;
...
/**
 * VietmapConstants exposes Vietmap related constants
 */
public class VietmapConstants {
   ...
   */
  public static final String MAPBOX_SHARED_PREFERENCES = "VietmapSharedPreferences";
  ...
  /**
   * Fragment Argument Key for VietmapMapOptions
   */
  public static final String FRAG_ARG_VietmapMapOPTIONS = "VietmapMapOptions";
