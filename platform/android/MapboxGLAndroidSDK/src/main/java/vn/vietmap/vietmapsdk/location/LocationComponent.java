...
import vn.vietmap.vietmapsdk.maps.VietmapMap.OnCameraIdleListener;
import vn.vietmap.vietmapsdk.maps.VietmapMap.OnCameraMoveListener;
import vn.vietmap.vietmapsdk.maps.VietmapMap.OnMapClickListener;
import vn.vietmap.vietmapsdk.maps.Style;
import vn.vietmap.vietmapsdk.maps.Transform;
//import com.vietmap.vietmapsdk.location.engine.GoogleLocationEngineImpl;
import com.vietmap.vietmapsdk.location.engine.MapboxFusedLocationEngineImpl;
...
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.DEFAULT_FASTEST_INTERVAL_MILLIS;
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.DEFAULT_INTERVAL_MILLIS;
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.DEFAULT_TRACKING_TILT_ANIM_DURATION;
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.DEFAULT_TRACKING_ZOOM_ANIM_DURATION;
import static vn.vietmap.vietmapsdk.location.LocationComponentConstants.TRANSITION_ANIMATION_DURATION_MS;
import static vn.vietmap.vietmapsdk.location.modes.RenderMode.GPS;
 ...
 * <p>
 * <strong>
 * To get the component object use {@link VietmapMap#getLocationComponent()} and activate it with
 ...
 * to the {@link MapboxFusedLocationEngineImpl}. If you'd like to utilize Google
 * Play Services
 * for more precise location updates, simply add the Google Play Location Services dependency in your build script.
 * This will make the default engine the {@link GoogleLocationEngineImpl} instead.
...
public final class LocationComponent {
   ...
   * Internal use.
   * <p>
   * To get the component object use {@link VietmapMap#getLocationComponent()}.
   */
  public LocationComponent(@NonNull VietmapMap vietmapMap,
                           @NonNull Transform transform,
                           @NonNull List<VietmapMap.OnDeveloperAnimationListener> developerAnimationListeners) {
  ...
  @VisibleForTesting
  LocationComponent(@NonNull VietmapMap vietmapMap,
                    @NonNull Transform transform,
                    @NonNull List<VietmapMap.OnDeveloperAnimationListener> developerAnimationListeners,
  ...
  private class CameraTransitionListener implements OnLocationCameraTransitionListener {
    ...
    private void reset(@CameraMode.Mode int cameraMode) {
      locationAnimatorCoordinator.resetAllCameraAnimations(vietmapMap.getCameraPosition(),
   ...
   * use one of {@link VietmapMap#moveCamera(CameraUpdate)},
   * {@link VietmapMap#easeCamera(CameraUpdate)} or {@link VietmapMap#animateCamera(CameraUpdate)} instead.
   * <p>
  ...
  public void zoomWhileTracking(double zoomLevel, long animationDuration,
                                @Nullable VietmapMap.CancelableCallback callback) {
    checkActivationState();
    if (!isLayerReady) {
    ...
    locationAnimatorCoordinator.feedNewZoomLevel(zoomLevel, vietmapMap.getCameraPosition(), animationDuration, callback);
  }
  ...
  /**
   * Cancels animation started by {@link #zoomWhileTracking(double, long, VietmapMap.CancelableCallback)}.
   */
  ...
  public void tiltWhileTracking(double tilt, long animationDuration,
    ...
    locationAnimatorCoordinator.feedNewTilt(tilt, vietmapMap.getCameraPosition(), animationDuration, callback);
  }
  ...
  /**
   * Cancels animation started by {@link #tiltWhileTracking(double, long, VietmapMap.CancelableCallback)}.
   */
   ...
   * <p>
   * Setting this <b>will not impact</b> any other animations schedule with {@link VietmapMap}, gesture animations or
   ...
   * <pre>
   * {@code
   * vietmapMap.addOnCameraIdleListener(new VietmapMap.OnCameraIdleListener() {
   *   {@literal @}Override
   *   public void onCameraIdle() {
   *     double zoom = vietmapMap.getCameraPosition().zoom;
   *     int maxAnimationFps;
   *     if (zoom < 5) {
   *       maxAnimationFps = 3;
   *     } else if (zoom < 10) {
   ...
   * {@link VietmapMap.OnMapClickListener#onMapClick(LatLng)} is going to be consumed
   ...
   * {@link VietmapMap.OnMapLongClickListener#onMapLongClick(LatLng)} is going to be consumed
   * and not pushed to the listeners registered after the component's activation.
   *
   * @param listener The location click listener that is invoked when the
   *                 location is clicked
  ...
  private void onLocationLayerStart() {
    if (!isComponentInitialized || !isComponentStarted || vietmapMap.getStyle() == null) {
      return;
    }
    ...
    if (!isLayerReady) {
      ...
      vietmapMap.addOnCameraIdleListener(onCameraIdleListener);
  ...
  private void onLocationLayerStop() {
    ...
    vietmapMap.removeOnCameraMoveListener(onCameraMoveListener);
    vietmapMap.removeOnCameraIdleListener(onCameraIdleListener);
  }
  ...
  private void initialize(@NonNull final Context context, @NonNull Style style, boolean useSpecializedLocationLayer,
    ...
    vietmapMap.addOnMapClickListener(onMapClickListener);
    vietmapMap.addOnMapLongClickListener(onMapLongClickListener);
    ...
    locationLayerController = new LocationLayerController(vietmapMap, style, sourceProvider, featureProvider,
    ...
    locationCameraController = new LocationCameraController(
      context, vietmapMap, transform, cameraTrackingChangedListener, options, onCameraMoveInvalidateListener);

    locationAnimatorCoordinator = new LocationAnimatorCoordinator(
      vietmapMap.getProjection(),
  ...
  private void updateLocation(@Nullable final Location location, @Nullable List<Location> intermediatePoints,
    ...
    CameraPosition currentCameraPosition = vietmapMap.getCameraPosition();
  ...
  private void updateCompassHeading(float heading) {
    locationAnimatorCoordinator.feedNewCompassBearing(heading, vietmapMap.getCameraPosition());
  }
  ...
  private void updateAccuracyRadius(Location location, boolean noAnimation) {
    ...
    if (location == null) {
      ...
      radius = Utils.calculateZoomLevelRadius(vietmapMap, location);
    }
  ...
  @NonNull
  private VietmapMap.OnMapLongClickListener onMapLongClickListener = new VietmapMap.OnMapLongClickListener() {
    @Override
  ...
  @NonNull
  private final VietmapMap.OnDeveloperAnimationListener developerAnimationListener =
    new VietmapMap.OnDeveloperAnimationListener() {
      @Override
  ...
  private void notifyUnsuccessfulCameraOperation(@Nullable VietmapMap.CancelableCallback callback,
                                                 @Nullable String msg) {
    if (msg != null) {
      Logger.e(TAG, msg);
    }
