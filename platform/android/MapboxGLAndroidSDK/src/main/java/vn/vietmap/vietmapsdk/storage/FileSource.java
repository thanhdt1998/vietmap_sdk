package vn.vietmap.vietmapsdk.storage;
...
import vn.vietmap.vietmapsdk.utils.FileUtils;
...
public class FileSource {
  ...
  private static String getCachePath(@NonNull Context context) {
    SharedPreferences preferences = context.getSharedPreferences(
      VietmapConstants.MAPBOX_SHARED_PREFERENCES, Context.MODE_PRIVATE);
    ...
    if (!isPathWritable(cachePath)) {
      ...
      SharedPreferences.Editor editor =
        context.getSharedPreferences(VietmapConstants.MAPBOX_SHARED_PREFERENCES, Context.MODE_PRIVATE).edit();
  ...
  private static boolean isExternalStorageConfiguration(@NonNull Context context) {
    // Default value
    boolean isExternalStorageConfiguration = VietmapConstants.DEFAULT_SET_STORAGE_EXTERNAL;
    ...
    try {
      ...
      if (appInfo.metaData != null) {
        isExternalStorageConfiguration = appInfo.metaData.getBoolean(
          VietmapConstants.KEY_META_DATA_SET_STORAGE_EXTERNAL,
          VietmapConstants.DEFAULT_SET_STORAGE_EXTERNAL
        );
      }
  ...
  public static void setResourcesCachePath(@NonNull final String path,
                                           @NonNull final ResourcesCachePathChangeCallback callback) {
    final Context applicationContext = Vietmap.getApplicationContext();
      ...
      new FileUtils.CheckFileWritePermissionTask(new FileUtils.OnCheckFileWritePermissionListener() {
        ...
        public void onWritePermissionGranted() {
          final SharedPreferences.Editor editor =
            applicationContext.getSharedPreferences(VietmapConstants.MAPBOX_SHARED_PREFERENCES,
  ...
  private FileSource(String cachePath) {
    TileServerOptions options = Vietmap.getTileServerOptions();
    initialize(Vietmap.getApiKey(), cachePath, options);
  }
