...
public class OfflineRegion {
  ...
  public interface OfflineRegionObserver {
    ...
    /*
     * Implement this method to be notified when the limit on the number of Vietmap
     ...
     * tiles from Vietmap APIs until existing tiles have been removed.
     *
     * This limit does not apply to non-Vietmap tile sources.
     *
     * This method will be executed on the main thread.
     */
  ...
  private OfflineRegion(long offlineRegionPtr, FileSource fileSource, long id,
    ...
    this.context = Vietmap.getApplicationContext();
  ...
  /**
   * Invalidate all the tiles from an offline region forcing Vietmap GL to revalidate
