...
import static vn.vietmap.vietmapsdk.style.expressions.Expression.ExpressionLiteral;
...
public class GeoJsonOptions extends HashMap<String, Object> {
  ...
  public GeoJsonOptions withClusterProperty(String propertyName, Expression operatorExpr, Expression mapExpr) {
    ...
    Object operator = (operatorExpr instanceof Expression.ExpressionLiteral)
            ? ((Expression.ExpressionLiteral)operatorExpr).toValue() : operatorExpr.toArray();
