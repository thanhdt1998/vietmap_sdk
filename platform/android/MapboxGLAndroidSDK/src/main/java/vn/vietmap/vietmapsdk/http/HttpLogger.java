package vn.vietmap.vietmapsdk.http;

import android.util.Log;

import vn.vietmap.vietmapsdk.log.Logger;

import static vn.vietmap.vietmapsdk.http.HttpRequest.CONNECTION_ERROR;
import static vn.vietmap.vietmapsdk.http.HttpRequest.TEMPORARY_ERROR;
