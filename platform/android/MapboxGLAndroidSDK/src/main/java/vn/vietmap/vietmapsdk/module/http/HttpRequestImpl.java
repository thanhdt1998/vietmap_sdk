...
import vn.vietmap.vietmapsdk.http.HttpIdentifier;
import vn.vietmap.vietmapsdk.http.HttpLogger;
import vn.vietmap.vietmapsdk.http.HttpRequest;
import vn.vietmap.vietmapsdk.http.HttpRequestUrl;
import vn.vietmap.vietmapsdk.http.HttpResponder;
import vn.vietmap.vietmapsdk.constants.VietmapConstants;
...
import static vn.vietmap.vietmapsdk.module.http.HttpRequestUtil.toHumanReadableAscii;

import com.mapbox.vietmapsdk.BuildConfig;
...
public class HttpRequestImpl implements HttpRequest {
  ...
  public void executeRequest(HttpResponder httpRequest, long nativePtr, @NonNull String resourceUrl,
    ...
    try {
      ...
      final String host = httpUrl.host().toLowerCase(VietmapConstants.MAPBOX_LOCALE);
      resourceUrl = HttpRequestUrl.buildResourceUrl(host, resourceUrl, httpUrl.querySize(), offlineUsage);

      final Request.Builder builder = new Request.Builder()
        .url(resourceUrl)
        .tag(resourceUrl.toLowerCase(VietmapConstants.MAPBOX_LOCALE))
