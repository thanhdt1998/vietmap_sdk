...
import vn.vietmap.vietmapsdk.maps.renderer.egl.EGLConfigChooser;
import vn.vietmap.vietmapsdk.maps.renderer.egl.EGLContextFactory;
import vn.vietmap.vietmapsdk.maps.renderer.egl.EGLWindowSurfaceFactory;
...
public class GLSurfaceViewMapRenderer extends MapRenderer implements GLSurfaceView.Renderer {
  ...
  @NonNull
  private final VietmapGLSurfaceView glSurfaceView;

  public GLSurfaceViewMapRenderer(Context context,
                                  VietmapGLSurfaceView glSurfaceView,
    ...
    glSurfaceView.setDetachedListener(new VietmapGLSurfaceView.OnGLSurfaceViewDetachedListener() {
      @Override
