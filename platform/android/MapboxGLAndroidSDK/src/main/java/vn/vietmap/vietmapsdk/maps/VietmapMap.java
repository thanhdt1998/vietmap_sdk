...
/**
 * The general class to interact with in the Android Vietmap SDK. It exposes the entry point for all
 * methods related to the MapView. You cannot instantiate {@link vn.vietmap.vietmapsdk.Vietmap} object directly, rather,
 * you must obtain one from the getMapAsync() method on a MapFragment or MapView that you have
 * added to your application.
 * <p>
 * Note: Similar to a View object, a VietmapMap should only be read and modified from the main thread.
 * </p>
 */
@UiThread
public final class VietmapMap {

  private static final String TAG = "Mbgl-VietmapMap";
  ...
  @Nullable
  private VietmapMap.OnFpsChangedListener onFpsChangedListener;
  ...
  VietmapMap(NativeMap map, Transform transform, UiSettings ui, Projection projection,
  ...
  void onSaveInstanceState(@NonNull Bundle outState) {
    outState.putParcelable(VietmapConstants.STATE_CAMERA_POSITION, transform.getCameraPosition());
    outState.putBoolean(VietmapConstants.STATE_DEBUG_ACTIVE, isDebugActive());
  ...
  void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
    final CameraPosition cameraPosition = savedInstanceState.getParcelable(VietmapConstants.STATE_CAMERA_POSITION);
    ...
    nativeMapView.setDebug(savedInstanceState.getBoolean(VietmapConstants.STATE_DEBUG_ACTIVE));
  }
  ...
  /**
   * Sets tile pre-fetching zoom delta from VietmapOptions.
   *
   * @param options the options object
   */
  private void setPrefetchesTiles(@NonNull VietMapOptions options) {
   ...
   * @see VietmapMap#setPrefetchesTiles(boolean)
   ...
   * Note: This operation will override the VietmapMapOptions#setPrefetchesTiles(boolean)
   ...
   * @see VietmapMap#setPrefetchZoomDelta(int)
   */
  @IntRange(from = 0)
  ...
  public void setMinZoomPreference(
    @FloatRange(from = VietmapConstants.MINIMUM_ZOOM, to = VietmapConstants.MAXIMUM_ZOOM) double minZoom) {
   ...
   */
  public void setMaxZoomPreference(@FloatRange(from = VietmapConstants.MINIMUM_ZOOM,
    to = VietmapConstants.MAXIMUM_ZOOM) double maxZoom) {
  ...
  public void setMinPitchPreference(
    @FloatRange(from = VietmapConstants.MINIMUM_PITCH, to = VietmapConstants.MAXIMUM_PITCH) double minPitch) {
   ...
   */
  public void setMaxPitchPreference(@FloatRange(from = VietmapConstants.MINIMUM_PITCH,
    to = VietmapConstants.MAXIMUM_PITCH) double maxPitch) {
  ...
  public final void moveCamera(@NonNull final CameraUpdate update,
                               @Nullable final VietmapMap.CancelableCallback callback) {
    notifyDeveloperAnimationListeners();
    transform.moveCamera(VietmapMap.this, update, callback);
  }
  ...
  public final void easeCamera(@NonNull CameraUpdate update) {
    easeCamera(update, VietmapConstants.ANIMATION_DURATION);
  }
   ...
   * @see CameraUpdateFactory for a set of updates.
   */
  public final void easeCamera(@NonNull CameraUpdate update, @Nullable final VietmapMap.CancelableCallback callback) {
    easeCamera(update, VietmapConstants.ANIMATION_DURATION, callback);
  }
  ...
  public final void easeCamera(@NonNull final CameraUpdate update,
    ...
    notifyDeveloperAnimationListeners();
    transform.easeCamera(VietmapMap.this, update, durationMs, easingInterpolator, callback);
  }
  ...
  public final void animateCamera(@NonNull CameraUpdate update) {
    animateCamera(update, VietmapConstants.ANIMATION_DURATION, null);
  }
   ...
   * @see CameraUpdateFactory for a set of updates.
   */
  public final void animateCamera(@NonNull CameraUpdate update, @Nullable VietmapMap.CancelableCallback callback) {
    animateCamera(update, VietmapConstants.ANIMATION_DURATION, callback);
  }
  ...
  public final void animateCamera(@NonNull final CameraUpdate update, final int durationMs,
    ...
    notifyDeveloperAnimationListeners();
    transform.animateCamera(VietmapMap.this, update, durationMs, callback);
  }
  ...
  private void setApiBaseUrl(@NonNull VietMapOptions options) {
   ...
   * Vietmap Annotation Plugin</a> instead
   */
  @Deprecated
  @NonNull
  ...
  @Nullable
  public CameraPosition getCameraForLatLngBounds(@NonNull LatLngBounds latLngBounds,
                                                 @FloatRange(from = VietmapConstants.MINIMUM_DIRECTION,
                                                   to = VietmapConstants.MAXIMUM_DIRECTION) double bearing,
                                                 @FloatRange(from = VietmapConstants.MINIMUM_TILT,
                                                   to = VietmapConstants.MAXIMUM_TILT) double tilt) {
   ...
   *
   * @see VietmapMap#addOnFlingListener(OnFlingListener)
   */
   ...
   *
   * @see VietmapMap#addOnMoveListener(OnMoveListener)
   */
   ...
   *
   * @see VietmapMap#addOnRotateListener(OnRotateListener)
   */
   ...
   *
   * @see VietmapMap#addOnScaleListener(OnScaleListener)
   */
   ...
   *
   * @see VietmapMap#addOnShoveListener(OnShoveListener)
   */
   ...
   *
   * @see VietmapMap#setOnFpsChangedListener(OnFpsChangedListener)
   */
   ...
   *
   * @see VietmapMap#addOnMapClickListener(OnMapClickListener)
   */
   ...
   *
   * @see VietmapMap#addOnMapLongClickListener(OnMapLongClickListener)
   */
   ...
   *
   * @see VietmapMap#setOnMarkerClickListener(OnMarkerClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * Vietmap Annotation Plugin</a> instead
   */
   ...
   *
   * @see VietmapMap#setOnPolygonClickListener(OnPolygonClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * Vietmap Annotation Plugin</a> instead
   */
   ...
   *
   * @see VietmapMap#setOnPolylineClickListener(OnPolylineClickListener)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * Vietmap Annotation Plugin</a> instead
   */
   ...
   *
   * @see VietmapMap#setOnInfoWindowClickListener(OnInfoWindowClickListener)
   */
   ...
   *
   * @see VietmapMap#setOnInfoWindowCloseListener(OnInfoWindowCloseListener)
   */
   ...
   *
   * @see VietmapMap#setInfoWindowAdapter(InfoWindowAdapter)
   * @deprecated As of 7.0.0,
   * use <a href="https://github.com/mapbox/mapbox-plugins-android/tree/master/plugin-annotation">
   * Vietmap Annotation Plugin</a> instead
   */
