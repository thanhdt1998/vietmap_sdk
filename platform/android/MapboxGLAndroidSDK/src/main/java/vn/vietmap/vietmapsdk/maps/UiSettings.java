...
/**
 * Settings for the user interface of a VietMapMap. To obtain this interface, call getUiSettings().
 */
public final class UiSettings {
  ...
  void initialise(@NonNull Context context, @NonNull VietMapOptions options) {
  ...
  private void initialiseGestures(VietMapOptions options) {
  ...
  private void saveGestures(Bundle outState) {
    outState.putBoolean(VietmapConstants.STATE_HORIZONAL_SCROLL_ENABLED, isHorizontalScrollGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_ZOOM_ENABLED, isZoomGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_SCROLL_ENABLED, isScrollGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_ROTATE_ENABLED, isRotateGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_TILT_ENABLED, isTiltGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_DOUBLE_TAP_ENABLED, isDoubleTapGesturesEnabled());
    outState.putBoolean(VietmapConstants.STATE_SCALE_ANIMATION_ENABLED, isScaleVelocityAnimationEnabled());
    outState.putBoolean(VietmapConstants.STATE_ROTATE_ANIMATION_ENABLED, isRotateVelocityAnimationEnabled());
    outState.putBoolean(VietmapConstants.STATE_FLING_ANIMATION_ENABLED, isFlingVelocityAnimationEnabled());
    outState.putBoolean(VietmapConstants.STATE_INCREASE_ROTATE_THRESHOLD, isIncreaseRotateThresholdWhenScaling());
    outState.putBoolean(VietmapConstants.STATE_DISABLE_ROTATE_WHEN_SCALING, isDisableRotateWhenScaling());
    outState.putBoolean(VietmapConstants.STATE_INCREASE_SCALE_THRESHOLD, isIncreaseScaleThresholdWhenRotating());
    outState.putBoolean(VietmapConstants.STATE_QUICK_ZOOM_ENABLED, isQuickZoomGesturesEnabled());
    outState.putFloat(VietmapConstants.STATE_ZOOM_RATE, getZoomRate());
  }

  private void restoreGestures(Bundle savedInstanceState) {
    setHorizontalScrollGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_HORIZONAL_SCROLL_ENABLED));
    setZoomGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_ZOOM_ENABLED));
    setScrollGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_SCROLL_ENABLED));
    setRotateGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_ROTATE_ENABLED));
    setTiltGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_TILT_ENABLED));
    setDoubleTapGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_DOUBLE_TAP_ENABLED));
    setScaleVelocityAnimationEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_SCALE_ANIMATION_ENABLED));
    setRotateVelocityAnimationEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_ROTATE_ANIMATION_ENABLED));
    setFlingVelocityAnimationEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_FLING_ANIMATION_ENABLED));
    setIncreaseRotateThresholdWhenScaling(
      savedInstanceState.getBoolean(VietmapConstants.STATE_INCREASE_ROTATE_THRESHOLD));
    setDisableRotateWhenScaling(savedInstanceState.getBoolean(VietmapConstants.STATE_DISABLE_ROTATE_WHEN_SCALING));
    setIncreaseScaleThresholdWhenRotating(
      savedInstanceState.getBoolean(VietmapConstants.STATE_INCREASE_SCALE_THRESHOLD));
    setQuickZoomGesturesEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_QUICK_ZOOM_ENABLED));
    setZoomRate(savedInstanceState.getFloat(VietmapConstants.STATE_ZOOM_RATE, 1.0f));
  }

  private void initialiseCompass(VietMapOptions options, @NonNull Resources resources) {
  ...
  private void saveCompass(Bundle outState) {
    outState.putBoolean(VietmapConstants.STATE_COMPASS_ENABLED, isCompassEnabled());
    outState.putInt(VietmapConstants.STATE_COMPASS_GRAVITY, getCompassGravity());
    outState.putInt(VietmapConstants.STATE_COMPASS_MARGIN_LEFT, getCompassMarginLeft());
    outState.putInt(VietmapConstants.STATE_COMPASS_MARGIN_TOP, getCompassMarginTop());
    outState.putInt(VietmapConstants.STATE_COMPASS_MARGIN_BOTTOM, getCompassMarginBottom());
    outState.putInt(VietmapConstants.STATE_COMPASS_MARGIN_RIGHT, getCompassMarginRight());
    outState.putBoolean(VietmapConstants.STATE_COMPASS_FADE_WHEN_FACING_NORTH, isCompassFadeWhenFacingNorth());
    outState.putByteArray(VietmapConstants.STATE_COMPASS_IMAGE_BITMAP,
      BitmapUtils.getByteArrayFromDrawable(getCompassImage()));
  }

  private void restoreCompass(Bundle savedInstanceState) {
    boolean compassEnabled = savedInstanceState.getBoolean(VietmapConstants.STATE_COMPASS_ENABLED);
    if (compassEnabled && !isCompassInitialized) {
      compassView = mapView.initialiseCompassView();
      isCompassInitialized = true;
    }
    setCompassEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_COMPASS_ENABLED));
    setCompassGravity(savedInstanceState.getInt(VietmapConstants.STATE_COMPASS_GRAVITY));
    setCompassMargins(savedInstanceState.getInt(VietmapConstants.STATE_COMPASS_MARGIN_LEFT),
      savedInstanceState.getInt(VietmapConstants.STATE_COMPASS_MARGIN_TOP),
      savedInstanceState.getInt(VietmapConstants.STATE_COMPASS_MARGIN_RIGHT),
      savedInstanceState.getInt(VietmapConstants.STATE_COMPASS_MARGIN_BOTTOM));
    setCompassFadeFacingNorth(savedInstanceState.getBoolean(VietmapConstants.STATE_COMPASS_FADE_WHEN_FACING_NORTH));
    setCompassImage(BitmapUtils.getDrawableFromByteArray(
      mapView.getContext(), savedInstanceState.getByteArray(VietmapConstants.STATE_COMPASS_IMAGE_BITMAP)));
  }

  private void initialiseLogo(VietMapOptions options, @NonNull Resources resources) {
  ...
  private void saveLogo(Bundle outState) {
    outState.putInt(VietmapConstants.STATE_LOGO_GRAVITY, getLogoGravity());
    outState.putInt(VietmapConstants.STATE_LOGO_MARGIN_LEFT, getLogoMarginLeft());
    outState.putInt(VietmapConstants.STATE_LOGO_MARGIN_TOP, getLogoMarginTop());
    outState.putInt(VietmapConstants.STATE_LOGO_MARGIN_RIGHT, getLogoMarginRight());
    outState.putInt(VietmapConstants.STATE_LOGO_MARGIN_BOTTOM, getLogoMarginBottom());
    outState.putBoolean(VietmapConstants.STATE_LOGO_ENABLED, isLogoEnabled());
  }

  private void restoreLogo(Bundle savedInstanceState) {
    boolean logoEnabled = savedInstanceState.getBoolean(VietmapConstants.STATE_LOGO_ENABLED);
    if (logoEnabled && !isLogoInitialized) {
      logoView = mapView.initialiseLogoView();
      isLogoInitialized = true;
    }
    setLogoEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_LOGO_ENABLED));
    setLogoGravity(savedInstanceState.getInt(VietmapConstants.STATE_LOGO_GRAVITY));
    setLogoMargins(savedInstanceState.getInt(VietmapConstants.STATE_LOGO_MARGIN_LEFT),
      savedInstanceState.getInt(VietmapConstants.STATE_LOGO_MARGIN_TOP),
      savedInstanceState.getInt(VietmapConstants.STATE_LOGO_MARGIN_RIGHT),
      savedInstanceState.getInt(VietmapConstants.STATE_LOGO_MARGIN_BOTTOM));
  }

  private void initialiseAttribution(@NonNull Context context, VietMapOptions options) {
  ...
  private void saveAttribution(Bundle outState) {
    outState.putInt(VietmapConstants.STATE_ATTRIBUTION_GRAVITY, getAttributionGravity());
    outState.putInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_LEFT, getAttributionMarginLeft());
    outState.putInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_TOP, getAttributionMarginTop());
    outState.putInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_RIGHT, getAttributionMarginRight());
    outState.putInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_BOTTOM, getAttributionMarginBottom());
    outState.putBoolean(VietmapConstants.STATE_ATTRIBUTION_ENABLED, isAttributionEnabled());
  }

  private void restoreAttribution(Bundle savedInstanceState) {
    boolean attributionEnabled = savedInstanceState.getBoolean(VietmapConstants.STATE_ATTRIBUTION_ENABLED);
    if (attributionEnabled && !isAttributionInitialized) {
      attributionsView = mapView.initialiseAttributionView();
      isAttributionInitialized = true;
    }
    setAttributionEnabled(savedInstanceState.getBoolean(VietmapConstants.STATE_ATTRIBUTION_ENABLED));
    setAttributionGravity(savedInstanceState.getInt(VietmapConstants.STATE_ATTRIBUTION_GRAVITY));
    setAttributionMargins(savedInstanceState.getInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_LEFT),
      savedInstanceState.getInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_TOP),
      savedInstanceState.getInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_RIGHT),
      savedInstanceState.getInt(VietmapConstants.STATE_ATTRIBUTION_MARGIN_BOTTOM));
  }
  ...
  public void setCompassEnabled(boolean compassEnabled) {
    if (compassEnabled && !isCompassInitialized) {
      initialiseCompass(mapView.VietmapMapOptions, mapView.getContext().getResources());
    }
    if (compassView != null) {
  ...
  /**
   * <p>
   * Enables or disables the VietMap logo.
   * </p>
  ...
  public void setLogoEnabled(boolean enabled) {
    if (enabled && !isLogoInitialized) {
      initialiseLogo(mapView.VietmapMapOptions, mapView.getContext().getResources());
    }
    if (logoView != null) {
  ...
  /**
   * Sets the margins of the logo view in pixels. Use this to change the distance of the VietMap logo from the
   * map view edge.
   *
   * @param left   The left margin in pixels.
   * @param top    The top margin in pixels.
  ...
  public void setAttributionEnabled(boolean enabled) {
    if (enabled && !isAttributionInitialized) {
      initialiseAttribution(mapView.getContext(), mapView.VietmapMapOptions);
    }
   ...
   * </p>
   * By default, the attribution is in the bottom left corner next to the VietMap logo.
   *
   * @param gravity Android SDK Gravity.
   */
  ...
  private void restoreDeselectMarkersOnTap(Bundle savedInstanceState) {
    setDeselectMarkersOnTap(savedInstanceState.getBoolean(VietmapConstants.STATE_DESELECT_MARKER_ON_TAP));
  }

  private void saveDeselectMarkersOnTap(Bundle outState) {
    outState.putBoolean(VietmapConstants.STATE_DESELECT_MARKER_ON_TAP, isDeselectMarkersOnTap());
  }
  ...
  private void saveFocalPoint(Bundle outState) {
    outState.putParcelable(VietmapConstants.STATE_USER_FOCAL_POINT, getFocalPoint());
  }

  private void restoreFocalPoint(Bundle savedInstanceState) {
    PointF pointF = savedInstanceState.getParcelable(VietmapConstants.STATE_USER_FOCAL_POINT);
    if (pointF != null) {
