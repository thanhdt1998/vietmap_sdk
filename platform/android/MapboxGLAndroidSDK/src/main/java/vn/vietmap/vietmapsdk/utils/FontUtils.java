...
import static vn.vietmap.vietmapsdk.constants.VietmapConstants.DEFAULT_FONT;
...
public class FontUtils {
  ...
  public static String extractValidFont(String... fontNames) {
    ...
    Logger.i(TAG, String.format(
      "Couldn't map font family for local ideograph, using %s instead", VietmapConstants.DEFAULT_FONT)
    );
    return VietmapConstants.DEFAULT_FONT;
  }
