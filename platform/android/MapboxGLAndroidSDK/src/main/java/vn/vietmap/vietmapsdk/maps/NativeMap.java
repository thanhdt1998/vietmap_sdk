...
interface NativeMap {
  ...
  void setOnFpsChangedListener(@NonNull VietmapMap.OnFpsChangedListener listener);
  ...
  void addSnapshotCallback(@NonNull VietmapMap.SnapshotReadyCallback callback);
}