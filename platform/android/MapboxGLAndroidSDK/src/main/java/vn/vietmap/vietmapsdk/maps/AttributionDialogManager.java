...
import vn.vietmap.vietmapsdk.attribution.Attribution;
...
public class AttributionDialogManager implements View.OnClickListener, DialogInterface.OnClickListener {
  ...
  public AttributionDialogManager(@NonNull Context context, @NonNull VietmapMap VietmapMap) {
  ...
  public void onClick(@NonNull View view) {
    attributionSet = new AttributionBuilder(VietmapMap, view.getContext()).build();
  ...
  private void showMapAttributionWebPage(int which) {
    ...
    if (url.contains(MAP_FEEDBACK_URL_OLD) || url.contains(MAP_FEEDBACK_URL)) {
      url = buildMapFeedbackMapUrl(Vietmap.getApiKey());
    }
    showWebPage(url);
  }
  ...
  String buildMapFeedbackMapUrl(@Nullable String apiKey) {
    ...
    Style style = VietmapMap.getStyle();
    if (style != null) {
  ...
  private static class AttributionBuilder {
    ...
    AttributionBuilder(VietmapMap VietmapMap, Context context) {
      this.VietmapMap = VietmapMap;
