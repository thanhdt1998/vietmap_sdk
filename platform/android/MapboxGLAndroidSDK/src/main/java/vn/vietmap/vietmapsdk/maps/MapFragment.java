...
public final class MapFragment extends Fragment implements OnMapReadyCallback {
   ...
   *
   * @param VietmapMapOptions The configuration options to be used.
   * @return MapFragment instantiated.
   */
  @NonNull
  public static MapFragment newInstance(@Nullable VietMapOptions VietmapMapOptions) {
    MapFragment mapFragment = new MapFragment();
    mapFragment.setArguments(MapFragmentUtils.createFragmentArgs(VietmapMapOptions));
    return mapFragment;
  }
  ...
  public void onInflate(@NonNull Context context, AttributeSet attrs, Bundle savedInstanceState) {
    ...
    setArguments(MapFragmentUtils.createFragmentArgs(VietMapOptions.createFromAttributes(context, attrs)));
  }
   ...
   *
   * @param VietmapMap The public api controller of the map
   */
  @Override
  public void onMapReady(@NonNull VietmapMap VietmapMap) {
    ...
    for (OnMapReadyCallback onMapReadyCallback : mapReadyCallbackList) {
      onMapReadyCallback.onMapReady(VietmapMap);
    }
  }
  ...
  /**
   * Sets a callback object which will be triggered when the VietmapMap instance is ready to be used.
   *
