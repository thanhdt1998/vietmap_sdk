...
import vn.vietmap.vietmapsdk.maps.VietmapMap.OnFpsChangedListener
 ...
 */
open class DebugModeActivity : AppCompatActivity(),
    vn.vietmap.vietmapsdk.maps.OnMapReadyCallback, OnFpsChangedListener {
    ...
    private fun setupMapView(savedInstanceState: Bundle?) {
        val mapboxMapOptions = setupVietmapMapOptions()
    ...
    protected open fun setupVietmapMapOptions(): vn.vietmap.vietmapsdk.maps.VietMapOptions {
        return vn.vietmap.vietmapsdk.maps.VietMapOptions.createFromAttributes(this, null)
    }

    override fun onMapReady(map: vn.vietmap.vietmapsdk.maps.VietmapMap) {
        mapboxMap = map
        mapboxMap!!.setStyle(
            vn.vietmap.vietmapsdk.maps.Style.Builder().fromUri(STYLES[currentStyleIndex])
        ) { style: vn.vietmap.vietmapsdk.maps.Style -> setupNavigationView(style.layers) }
        setupZoomView()
        setFpsView()
    }
    ...
    private fun setupNavigationView(layerList: List<vn.vietmap.vietmapsdk.style.layers.Layer>) {
    ...
    private fun toggleLayerVisibility(layer: vn.vietmap.vietmapsdk.style.layers.Layer) {
        val isVisible = layer.visibility.getValue() == vn.vietmap.vietmapsdk.style.layers.Property.VISIBLE
        layer.setProperties(
            vn.vietmap.vietmapsdk.style.layers.PropertyFactory.visibility(
                if (isVisible) vn.vietmap.vietmapsdk.style.layers.Property.NONE else vn.vietmap.vietmapsdk.style.layers.Property.VISIBLE
            )
        )
    }
    ...
    private fun setupStyleChangeView() {
        ...
        fabStyles.setOnClickListener { view: View? ->
            if (mapboxMap != null) {
                ...
                mapboxMap!!.setStyle(vn.vietmap.vietmapsdk.maps.Style.Builder().fromUri(STYLES[currentStyleIndex]))
            }
        }
    }
    ...
    private class LayerListAdapter internal constructor(context: Context?, layers: List<vn.vietmap.vietmapsdk.style.layers.Layer>) :
        BaseAdapter() {
        private val layoutInflater: LayoutInflater
        private val layers: List<vn.vietmap.vietmapsdk.style.layers.Layer>
        override fun getCount(): Int {
            return layers.size
        }

        override fun getItem(position: Int): vn.vietmap.vietmapsdk.style.layers.Layer {
