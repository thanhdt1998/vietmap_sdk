 ...
 *
 *
 * Uses VietMapOptions to initialise the Fragment.
 *
 */
class SupportMapFragmentActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapFragment: vn.vietmap.vietmapsdk.maps.SupportMapFragment?
        if (savedInstanceState == null) {
            mapFragment = vn.vietmap.vietmapsdk.maps.SupportMapFragment.newInstance(createFragmentOptions())
            supportFragmentManager
                .beginTransaction()
                .add(R.id.fragment_container, mapFragment, TAG)
                .commit()
        } else {
            mapFragment = supportFragmentManager.findFragmentByTag(TAG) as vn.vietmap.vietmapsdk.maps.SupportMapFragment?
        }
