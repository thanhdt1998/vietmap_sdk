...
import static vn.vietmap.vietmapsdk.constants.VietmapConstants.DEFAULT_MEASURE_TILE_DOWNLOAD_ON;
import static vn.vietmap.vietmapsdk.constants.VietmapConstants.KEY_META_DATA_MEASURE_TILE_DOWNLOAD_ON;
...
public class TileLoadingMeasurementUtils {
  ...
  private static boolean isBooleanMetaDataValueOn(@NonNull String propKey, boolean defaultValue) {
    ...
    try {
      ...
      Context context = Vietmap.getApplicationContext();
...
//      Timber.e("Failed to read the package metadata: %s", exception);
  ...
  static class TileLoadingInterceptor implements Interceptor {
    ...
    private static String getRam() {
      ActivityManager actManager =
              (ActivityManager) Vietmap.getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    private static String getWindowSize() {
      WindowManager windowManager =
              (WindowManager) Vietmap.getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    private static String getConnectionState() {
      Context appContext = Vietmap.getApplicationContext();
