...
class RenderTestActivity : AppCompatActivity() {
    ...
    private lateinit var mapSnapshotter: vn.vietmap.vietmapsdk.snapshotter.MapSnapshotter
    ...
    private fun render(renderTestDefinition: RenderTestDefinition, testSize: Int) {
        ...
        mapSnapshotter.start(
            vn.vietmap.vietmapsdk.snapshotter.MapSnapshotter.SnapshotReadyCallback { result: vn.vietmap.vietmapsdk.snapshotter.MapSnapshot ->
