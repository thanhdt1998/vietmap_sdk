...
class BottomSheetActivity : AppCompatActivity() {
    ...
    class MainMapFragment : Fragment(),
        ...
        private var map: vn.vietmap.vietmapsdk.maps.MapView? = null
        override fun onCreateView(
            ...
            return vn.vietmap.vietmapsdk.maps.MapView(
                context,
        ...
        companion object {
            ...
            fun newInstance(context: Context?, mapCounter: Int): MainMapFragment {
                ...
                val mapboxMapOptions = vn.vietmap.vietmapsdk.maps.VietMapOptions.createFromAttributes(context!!)
                mapFragment.arguments = vn.vietmap.vietmapsdk.utils.MapFragmentUtils.createFragmentArgs(mapboxMapOptions)
                return mapFragment
            }
        }
    }
    ...
    class BottomSheetFragment : Fragment(),
        ...
        override fun onMapReady(mapboxMap: vn.vietmap.vietmapsdk.maps.VietmapMap) {
            ...
            mapboxMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Bright"))
        }
    ...
    companion object {
        private const val TAG_MAIN_FRAGMENT = "vn.vietmap.vietmapsdk.fragment.tag.main"
        private const val TAG_BOTTOM_FRAGMENT = "vn.vietmap.vietmapsdk.fragment.tag.bottom"
