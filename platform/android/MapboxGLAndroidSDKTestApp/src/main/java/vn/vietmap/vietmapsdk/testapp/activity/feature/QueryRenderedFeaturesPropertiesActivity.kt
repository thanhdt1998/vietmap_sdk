...
class QueryRenderedFeaturesPropertiesActivity : AppCompatActivity() {
    ...
    private class CustomMarker internal constructor(
        baseMarkerOptions: vn.vietmap.vietmapsdk.annotations.BaseMarkerOptions<*, *>?,
        val features: List<Feature>?
    ) : vn.vietmap.vietmapsdk.annotations.Marker(baseMarkerOptions)

    private class CustomMarkerOptions :
        vn.vietmap.vietmapsdk.annotations.BaseMarkerOptions<CustomMarker?, CustomMarkerOptions?> {
