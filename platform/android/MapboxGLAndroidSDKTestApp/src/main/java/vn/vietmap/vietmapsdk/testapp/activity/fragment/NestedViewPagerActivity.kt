            ...
            override fun getItem(position: Int): androidx.fragment.app.Fragment {
                ...
                when (position) {
                    0 -> {
                        ...
                        fragment.getMapAsync { VietmapMap -> VietmapMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Streets")) }
                        return fragment
                    }
                    1 -> {
                    ...
                    2 -> {
                        ...
                        val fragment = vn.vietmap.vietmapsdk.maps.SupportMapFragment.newInstance(options)
                        fragment.getMapAsync { VietmapMap -> VietmapMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Pastel")) }
                        return fragment
                    }
                    3 -> {
                        return EmptyFragment.newInstance()
                    ...
                    4 -> {
                        ...
                        val fragment = vn.vietmap.vietmapsdk.maps.SupportMapFragment.newInstance(options)
                        fragment.getMapAsync { VietmapMap -> VietmapMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Satellite Hybrid")) }
                        return fragment
                    }
                    5 -> {
                        return EmptyFragment.newInstance()
