 ...
 */
class CameraAnimationTypeActivity : AppCompatActivity(),
    ...
    override fun onMapReady(map: vn.vietmap.vietmapsdk.maps.VietmapMap) {
        ...
        animateButton?.setOnClickListener { view: View? ->
            val cameraPosition =
                vn.vietmap.vietmapsdk.camera.CameraPosition.Builder().target(nextLatLng).bearing(270.0).tilt(20.0).build()
    ...
    private val nextLatLng: vn.vietmap.vietmapsdk.geometry.LatLng
        private get() {
    ...
    companion object {
        private val LAT_LNG_LONDON_EYE =
            vn.vietmap.vietmapsdk.geometry.LatLng(51.50325, -0.11968)
        private val LAT_LNG_TOWER_BRIDGE =
            vn.vietmap.vietmapsdk.geometry.LatLng(51.50550, -0.07520)
    }
}
