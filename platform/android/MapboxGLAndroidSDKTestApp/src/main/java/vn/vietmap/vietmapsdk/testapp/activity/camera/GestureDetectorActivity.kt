...
import vn.vietmap.vietmapsdk.testapp.utils.FontCache
...
class GestureDetectorActivity : AppCompatActivity() {
    ...
    private var focalPointLatLng: vn.vietmap.vietmapsdk.geometry.LatLng? = null
    ...
    private fun fixedFocalPointEnabled(enabled: Boolean) {
        if (enabled) {
            focalPointLatLng =
                vn.vietmap.vietmapsdk.geometry.LatLng(51.50325, -0.12968)
            marker = mapboxMap!!.addMarker(
                vn.vietmap.vietmapsdk.annotations.MarkerOptions().position(focalPointLatLng))
            mapboxMap!!.easeCamera(
                vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngZoom(focalPointLatLng!!, 16.0),
    ...
    private class GestureAlertsAdapter : RecyclerView.Adapter<GestureAlertsAdapter.ViewHolder>() {
        ...
        class ViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
            ...
            init {
                val typeface = vn.vietmap.vietmapsdk.testapp.utils.FontCache.get("Roboto-Regular.ttf", view.context)
