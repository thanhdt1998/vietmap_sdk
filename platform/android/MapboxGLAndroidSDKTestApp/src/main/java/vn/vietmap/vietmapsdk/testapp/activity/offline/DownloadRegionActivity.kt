 ...
 */
class DownloadRegionActivity : AppCompatActivity(), vn.vietmap.vietmapsdk.offline.OfflineRegion.OfflineRegionObserver {
    ...
    private lateinit var offlineManager: vn.vietmap.vietmapsdk.offline.OfflineManager
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        offlineManager.setOfflineVietmapTileCountLimit(Long.MAX_VALUE)
        initUi()
    ...
    private fun startDownload(region: vn.vietmap.vietmapsdk.offline.OfflineRegion) {
        downloading = true
        fab.setImageResource(R.drawable.ic_pause_black_24dp)
        logMessage("Downloading...")

        region.setObserver(this)
        region.setDownloadState(vn.vietmap.vietmapsdk.offline.OfflineRegion.STATE_ACTIVE)
    ...
    private fun pauseDownload(region: vn.vietmap.vietmapsdk.offline.OfflineRegion) {
        downloading = false
        fab.setImageResource(R.drawable.ic_play_arrow_black_24dp)
        handler.removeCallbacksAndMessages(null)
        region.setDownloadState(vn.vietmap.vietmapsdk.offline.OfflineRegion.STATE_INACTIVE)
        "Paused".let {
            logMessage(it)
    ...
    fun deleteOldOfflineRegions(onCompleted: () -> Unit) {
        offlineManager.listOfflineRegions(object : vn.vietmap.vietmapsdk.offline.OfflineManager.ListOfflineRegionsCallback {
            override fun onList(offlineRegions: Array<out vn.vietmap.vietmapsdk.offline.OfflineRegion>) {
                ...
                if (count > 0) {
                    ...
                    offlineRegions.forEach {
                        it.delete(object : vn.vietmap.vietmapsdk.offline.OfflineRegion.OfflineRegionDeleteCallback {
    ...
    private fun initSeekbars() {
        val maxZoom = vn.vietmap.vietmapsdk.constants.VietmapConstants.MAXIMUM_ZOOM.toInt()
    ...
    private fun initSpinner() {
        ...
        styles.add(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Streets"))
        styles.add(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Pastel"))
        styles.add(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Bright"))
        styles.add(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Outdoor"))
