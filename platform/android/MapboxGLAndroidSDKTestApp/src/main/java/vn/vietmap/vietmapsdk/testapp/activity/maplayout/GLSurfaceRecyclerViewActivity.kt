...
open class GLSurfaceRecyclerViewActivity : AppCompatActivity() {
    ...
    class ItemAdapter(private val activity: GLSurfaceRecyclerViewActivity, private val inflater: LayoutInflater) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
        ...
        private val items = listOf(
            "one", "two", "three", MapItem(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Streets")), "four", "five", MapItem(
                vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Pastel")), "seven", "eight", "nine", "ten",
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
            return if (viewType == TYPE_MAP) {
                val mapView = inflater.inflate(activity.getMapItemLayoutId(), parent, false) as vn.vietmap.vietmapsdk.maps.MapView
        ...
        class MapHolder(val mapView: vn.vietmap.vietmapsdk.maps.MapView) : androidx.recyclerview.widget.RecyclerView.ViewHolder(mapView) {
            ...
            fun bind(mapItem: MapItem) {
                mapView.getMapAsync { VietmapMap ->
                    VietmapMap.setStyle(mapItem.style) {
                        VietmapMap.snapshot { }
                    }
                }
            }
