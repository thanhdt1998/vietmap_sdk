...
import vn.vietmap.vietmapsdk.constants.GeometryConstants
...
class CameraPositionActivity :
    FragmentActivity(), vn.vietmap.vietmapsdk.maps.OnMapReadyCallback, View.OnClickListener, OnMapLongClickListener {
    ...
    override fun onMapReady(map: vn.vietmap.vietmapsdk.maps.VietmapMap) {
        mapboxMap = map
        map.setStyle(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Satellite Hybrid")) { style: vn.vietmap.vietmapsdk.maps.Style? ->
    ...
    override fun onMapLongClick(point: vn.vietmap.vietmapsdk.geometry.LatLng): Boolean {
        toggleLogCameraChanges()
        return false
    }
        ...
        override fun onClick(dialog: DialogInterface, which: Int) {
            ...
            val tilt =
                (dialogContent.findViewById<View>(R.id.value_tilt) as TextView)
                    ...
                    .toString()
                    .toDouble()
            if (latitude < vn.vietmap.vietmapsdk.constants.GeometryConstants.MIN_LATITUDE ||
                latitude > vn.vietmap.vietmapsdk.constants.GeometryConstants.MAX_LATITUDE
            ) {
                Toast.makeText(
                    dialogContent.context,
                    "latitude value must be set " +
                        " between " +
                        vn.vietmap.vietmapsdk.constants.GeometryConstants.MIN_LATITUDE +
                        " and " +
                        vn.vietmap.vietmapsdk.constants.GeometryConstants.MAX_LATITUDE,
                    Toast.LENGTH_SHORT
                )
                    .show()
                return
            ...
            mapboxMap!!.animateCamera(
                vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newCameraPosition(cameraPosition),
                5000,
