...
import com.mapbox.vietmapsdk.testapp.activity.espresso.DeviceIndependentTestActivity
...
class CameraUpdateFactoryTest : vn.vietmap.vietmapsdk.testapp.activity.BaseTest() {
    ...
    fun testLatLngBoundsUntiltedUnrotated() {
        mapboxMap.cameraPosition = vn.vietmap.vietmapsdk.camera.CameraPosition.Builder()
            .target(vn.vietmap.vietmapsdk.geometry.LatLng(60.0, 24.0))
            .bearing(0.0)
            .tilt(0.0)
            .build()

        val bounds: vn.vietmap.vietmapsdk.geometry.LatLngBounds = vn.vietmap.vietmapsdk.geometry.LatLngBounds.Builder()
            .include(vn.vietmap.vietmapsdk.geometry.LatLng(62.0, 26.0))
            .include(vn.vietmap.vietmapsdk.geometry.LatLng(58.0, 22.0))
            .build()

        mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngBounds(bounds, 0))
    ...
    fun testLatLngBoundsWithProvidedTiltAndRotation() {
        ...
        mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngBounds(bounds, 30.0, 40.0, 0))
    ...
    fun withPadding_cameraInvalidated_paddingPersisting() {
        ...
        mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.paddingTo(leftPadding.toDouble(), 0.0, 0.0, bottomPadding.toDouble()))
    ...
    fun withLatLngPadding_cameraInvalidated_paddingPersisting() {
        val expectedTarget = vn.vietmap.vietmapsdk.geometry.LatLng(2.0, 2.0)
        ...
        mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngPadding(expectedTarget, 0.0, topPadding.toDouble(), rightPadding.toDouble(), 0.0))
