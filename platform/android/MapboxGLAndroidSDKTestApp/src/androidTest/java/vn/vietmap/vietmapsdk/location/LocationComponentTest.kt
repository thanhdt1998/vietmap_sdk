...
import com.mapbox.vietmapsdk.location.utils.*
import com.mapbox.vietmapsdk.location.utils.MapboxTestingUtils.Companion.MAPBOX_HEAVY_STYLE
import com.mapbox.vietmapsdk.location.utils.MapboxTestingUtils.Companion.pushSourceUpdates
...
class LocationComponentTest : vn.vietmap.vietmapsdk.testapp.activity.EspressoTest() {
    ...
    private lateinit var locationComponentActivationOptions: vn.vietmap.vietmapsdk.location.LocationComponentActivationOptions
    ...
    fun locationComponent_initializesLocationEngineCorrectlyWhenOnesNotProvided() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                component: vn.vietmap.vietmapsdk.location.LocationComponent,
                mapboxMap: vn.vietmap.vietmapsdk.maps.MapboxMap,
    ...
    fun locationComponent_initializesLocationEngineCorrectlyWhenOnesNotProvidedButHasOptions() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                locationComponentActivationOptions = vn.vietmap.vietmapsdk.location.LocationComponentActivationOptions
                    .builder(context, style)
                    .locationComponentOptions(
                        vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context)
    ...
    fun settingMapStyleImmediatelyBeforeLoadingComponent_throwsInvalidStyle() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                mapboxMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.Builder().fromUrl(vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Bright")))
    ...
    fun locationComponentOptions_loadsForegroundBitmapFromNameOption() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val foregroundDrawable = vn.vietmap.vietmapsdk.utils.BitmapUtils.getDrawableFromRes(context, R.drawable.ic_media_play)
    ...
    fun locationComponentOptions_loadsGpsNameWithGpsRenderMode() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.renderMode = vn.vietmap.vietmapsdk.location.modes.RenderMode.GPS
                component.forceLocationUpdate(location)
                val foregroundDrawable = vn.vietmap.vietmapsdk.utils.BitmapUtils.getDrawableFromRes(context, R.drawable.ic_media_play)
                foregroundDrawable?.let {
                    mapboxMap.addImageFromDrawable("custom-foreground-bitmap", it)
    ...
    fun locationComponentOptions_customIconNameRevertsToDefault() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.applyStyle(vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context).build())
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun locationComponentOptions_customGpsIconNameChangeBackWithMode() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.renderMode = vn.vietmap.vietmapsdk.location.modes.RenderMode.NORMAL
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun locationComponentOptions_accuracyRingWithColor() {
        ...
        val rgbaColor = vn.vietmap.vietmapsdk.utils.ColorUtils.colorToRgbaString(color)
    ...
    fun mapChange_settingComponentStyle() {
        ...
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val options = vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context)
    ...
    fun animators_cameraLatLngBearingCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.cameraMode = vn.vietmap.vietmapsdk.location.modes.CameraMode.TRACKING_GPS
                location.bearing = 77f
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                uiController.loopMainThreadForAtLeast(MAX_ANIMATION_DURATION_MS)
    ...
    fun animators_cameraBearingCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.cameraMode = vn.vietmap.vietmapsdk.location.modes.CameraMode.NONE_GPS
    ...
    fun animators_cameraNoneCorrect() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.cameraMode = vn.vietmap.vietmapsdk.location.modes.CameraMode.NONE
                val latitude = mapboxMap.cameraPosition.target.latitude
                val longitude = mapboxMap.cameraPosition.target.longitude
    ...
    fun animators_focalPointAdjustment() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.cameraMode = vn.vietmap.vietmapsdk.location.modes.CameraMode.TRACKING
                component.cameraMode = vn.vietmap.vietmapsdk.location.modes.CameraMode.NONE
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun animators_dontZoomWhileTransitioning() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val zoom = mapboxMap.cameraPosition.zoom
                component.setCameraMode(vn.vietmap.vietmapsdk.location.modes.CameraMode.TRACKING_GPS, 500L, null, null, null, null)
    ...
    fun cameraPositionAdjustedToTrackingModeWhenComponentEnabled() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.bearingTo(90.0))
                component.isLocationComponentEnabled = true
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                uiController.loopMainThreadForAtLeast(MAX_ANIMATION_DURATION_MS)
    ...
    fun cameraPositionSnappedToTargetIfExceedsThreshold() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val target = vn.vietmap.vietmapsdk.geometry.LatLng(51.0, 17.0)
                mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLng(target))
                mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.zoomTo(15.0))
                mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.bearingTo(90.0))
                assertTrue(
                    vn.vietmap.vietmapsdk.location.Utils.immediateAnimation(mapboxMap.projection, mapboxMap.cameraPosition.target,
                        vn.vietmap.vietmapsdk.geometry.LatLng(location)
                    ))
    ...
    fun compassEngine_onComponentInitializedDefaultIsProvided() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                assertTrue(component.compassEngine is vn.vietmap.vietmapsdk.location.LocationComponentCompassEngine)
            }
        }
    ...
    fun compassEngine_changesWhenNewProvided() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                val engine: vn.vietmap.vietmapsdk.location.CompassEngine = object :
                    vn.vietmap.vietmapsdk.location.CompassEngine {
                    override fun addCompassListener(compassListener: vn.vietmap.vietmapsdk.location.CompassListener) {
                    }

                    override fun removeCompassListener(compassListener: vn.vietmap.vietmapsdk.location.CompassListener) {
                    }
