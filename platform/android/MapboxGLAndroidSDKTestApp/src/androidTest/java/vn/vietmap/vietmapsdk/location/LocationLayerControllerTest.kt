...
class LocationLayerControllerTest : vn.vietmap.vietmapsdk.testapp.activity.EspressoTest() {
    ...
    fun onMapChange_locationComponentPulsingCircleLayerGetsRedrawn() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.renderMode = vn.vietmap.vietmapsdk.location.modes.RenderMode.NORMAL
                component.forceLocationUpdate(location)
                styleChangeIdlingResource.waitForStyle(mapboxMap, vn.vietmap.vietmapsdk.maps.Style.getPredefinedStyle("Bright"))
                TestingAsyncUtils.waitForLayer(uiController, mapView)

                assertThat(component.renderMode, `is`(equalTo(vn.vietmap.vietmapsdk.location.modes.RenderMode.NORMAL)))

                // Check that the Source has been re-added to the new map style
                val source: vn.vietmap.vietmapsdk.style.sources.GeoJsonSource? = mapboxMap.style!!.getSourceAs(LOCATION_SOURCE)
    ...
    fun renderModeCompass_bearingLayersDoGetAdded() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.renderMode = vn.vietmap.vietmapsdk.location.modes.RenderMode.COMPASS
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun whenStyleChanged_continuesUsingStaleIcons() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.applyStyle(vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context).staleStateTimeout(100).build())
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun whenStyleChanged_staleStateChanges() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.isLocationComponentEnabled = true
                component.applyStyle(vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context).staleStateTimeout(1).build())
            ...
            override fun onLocationComponentAction(
                ...
                mapboxMap.moveCamera(
                    vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngZoom(
                        vn.vietmap.vietmapsdk.geometry.LatLng(location), 16.0))
                component.forceLocationUpdate(location)
                TestingAsyncUtils.waitForLayer(uiController, mapView)
                uiController.loopMainThreadForAtLeast(ACCURACY_RADIUS_ANIMATION_DURATION)

                assertEquals(
                    vn.vietmap.vietmapsdk.location.Utils.calculateZoomLevelRadius(mapboxMap, location) /*meters projected to radius on zoom 16*/,
    ...
    fun accuracy_visibleWhenCameraEased() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val target = vn.vietmap.vietmapsdk.geometry.LatLng(location)
                val zoom = 16.0
                mapboxMap.easeCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngZoom(target, zoom), 300)
    ...
    fun accuracy_visibleWhenCameraMoved() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                val target = vn.vietmap.vietmapsdk.geometry.LatLng(location)
                val zoom = 16.0
                mapboxMap.moveCamera(vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngZoom(target, zoom))
                TestingAsyncUtils.waitForLayer(uiController, mapView)
    ...
    fun applyStyle_layerBelow_restoreLayerVisibility() {
        val componentAction = object : LocationComponentAction.OnPerformLocationComponentAction {
            override fun onLocationComponentAction(
                ...
                component.applyStyle(vn.vietmap.vietmapsdk.location.LocationComponentOptions.builder(context).layerBelow("road-label").build())
    ...
    fun test_15026_missingShadowGradientRadius() {
        ...
        val shadowDrawable = vn.vietmap.vietmapsdk.utils.BitmapUtils.getDrawableFromRes(context, R.drawable.mapbox_user_icon_shadow_0px_test)
        vn.vietmap.vietmapsdk.location.Utils.generateShadow(shadowDrawable, 0f)
    }
