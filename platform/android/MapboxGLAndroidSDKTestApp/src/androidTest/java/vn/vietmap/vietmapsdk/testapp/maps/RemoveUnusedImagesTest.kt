...
class RemoveUnusedImagesTest : AppCenter() {
    ...
    private lateinit var mapboxMap: vn.vietmap.vietmapsdk.maps.MapboxMap
    ...
    fun setup() {
        rule.runOnUiThread {
            ...
            mapView.getMapAsync {
                mapboxMap = it
                mapboxMap.setStyle(vn.vietmap.vietmapsdk.maps.Style.Builder().fromJson(styleJson))
            }
        }
    }
            ...
            mapView.addOnCanRemoveUnusedStyleImageListener {
                ...
                mapboxMap.moveCamera(
                    vn.vietmap.vietmapsdk.camera.CameraUpdateFactory.newLatLngZoom(
                        vn.vietmap.vietmapsdk.geometry.LatLng(0.0, 120.0), 8.0))
