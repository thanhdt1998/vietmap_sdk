    ...
    fun testToScreenCoordinates() {
        rule.runOnUiThread {
            ...
            mapView.getMapAsync {
                ...
                val convertedFirst = projection.toScreenLocation(
                ...
                val convertedSecond = projection.toScreenLocation(
                    vn.vietmap.vietmapsdk.geometry.LatLng(
                        3.0,
                        4.0
                    )
    ...
    fun testFromScreenCoordinates() {
        rule.runOnUiThread {
            ...
            mapView.getMapAsync {
                ...
                val latLngFirst = vn.vietmap.vietmapsdk.geometry.LatLng(expected[0], expected[1])
                ...
                // check second latlng value
                val latLngSecond = vn.vietmap.vietmapsdk.geometry.LatLng(expected[2], expected[3])
