...
class ImageTest : vn.vietmap.vietmapsdk.testapp.activity.EspressoTest() {
    ...
    fun testAddGetImage() {
        validateTestSetup()
        vn.vietmap.vietmapsdk.testapp.action.MapboxMapAction.invoke(mapboxMap) { uiController, mapboxMap ->
